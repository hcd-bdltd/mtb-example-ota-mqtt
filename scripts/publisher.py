...
AMAZON_BROKER_ADDRESS = (
    "xxxxxxxxx-ats.iot.us-west-1.amazonaws.com"  # E.g : "b9m07l8775v3ky-ats.iot.us-west-2.amazonaws.com"
)
...
MOSQUITTO_BROKER_LOCAL_ADDRESS = "192.168.1.56"  # E.g : "192.168.27.243"
...
def publisher_recv_message(client, userdata, message):
    ...
    if message_type == MSG_TYPE_UPDATE_AVAILABLE:
        ...
        VERSION_MAJOR_STR, VERSION_MINOR_STR, VERSION_BUILD_STR = re.split(r"\.", update_app_version)
...
if __name__ == "__main__":
    ...
    print(
        "<kit>          CY8CPROTO_062S2_43439 | CY8CPROTO_062_4343W | CY8CKIT_062S2_43012 | CY8CEVAL_062S2_LAI_4373M2 | CY8CEVAL_062S2_MUR_43439M2 | CY8CPROTO_062S3_4343W | KIT_XMC72_EVK_MUR_43439M2 |"
    )
